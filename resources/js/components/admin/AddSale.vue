        ...
        .then((res) => {
          if (res.data.status == "Success") {
            ...
            for (var i = 0; i < res.data.data.detail.length; i++) {
             var detail =  res.data.data.detail[i]
              ...
              this.addProduct(
                ...
                if (
                detail.product_id.product_type ==
                "variable"
              ) {
                ...
                if (combination_detail.length > 0) {
                  ...
                  for (
                    ...
                    if(parseInt(detail.productCombinationId) == parseInt(combination_detail[
                        i
                      ].product_combination_id) )
                    ...
                    if (
                      combination_detail[i].combination.length > 0
                    ) {
                      for (
                        var j = 0;
                        j <
                        combination_detail[i].combination.length;
                        j++
                      ) {
                        if (j == 0) {
                          combination_name =
                            combination_detail[i].combination[j]
                    ...
                    arr.title =
                      product.detail.length > 0
                        ...
                        this.addCombinationProduct(arr,arr.product_combination_id);
